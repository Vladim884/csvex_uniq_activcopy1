...
router.post('/finduserbyid', [cookieJwtAdminAuth.cookAuth, cookieJwtAdminAuth.adminAuth], adminController.finduserbyid)
router.post('/finduserpage', [cookieJwtAdminAuth.cookAuth, cookieJwtAdminAuth.adminAuth], adminController.finduserPageRender)
router.post('/finduserpageid', [cookieJwtAdminAuth.cookAuth, cookieJwtAdminAuth.adminAuth], adminController.finduserPageByIdRender)
